...
npm run ui-test           # real-GUI verification (headless Electron, 28 DOM assertions incl. a11y + reactive i18n + cold-start gating + friction entry + competence badges + due/interleave/dashboard)
npm run lint              # oxlint
