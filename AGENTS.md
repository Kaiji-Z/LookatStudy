...
npm run verify:core       # 126 pure-Node/tsx logic test suites (v0.36 +verify-learner-profile/boot-guide/boot-quiz) (incl. verify-serve: real bundle child process;verify-build-manifest 无 dist 时 SKIP,CI 在 vite build 后另跑;六个安全加固套件 ipc-input-guards/xss-hardening/db-migration/secret-handling/engine-hardening/p23-hardening 守 2026-09-13 审计修复面)
