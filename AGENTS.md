...
npm run verify:core       # 130 pure-Node/tsx logic test suites (v0.38 +verify-model-catalog:目录三层合并/填充不覆盖/协议四点/资产三触点) (incl. verify-serve: real bundle child process;verify-build-manifest 无 dist 时 SKIP,CI 在 vite build 后另跑;六个安全加固套件 ipc-input-guards/xss-hardening/db-migration/secret-handling/engine-hardening/p23-hardening 守 2026-09-13 审计修复面)
