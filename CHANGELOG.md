...
### Added
- **伴学 v5:栏内临场感打磨** —— **中栏半身藏进输入卡后**:他放大到 76px,骑在输入框卡片上缘,下半身隐进卡片后面(沿卡缘裁剪,最多藏 34%——手臂永远露在外面拍键,藏进卡里的部分也不会挡住卡内按钮),并在输入框附近轻轻游动漂浮(慢利萨茹漂移,不是钉死)。**打字反馈升级**:从"手臂小抖"放大为**大幅拍臂(±52°,带回弹过冲)+ 整机随每次击键压弹一下**——一眼就知道他在跟你的键盘走。**右栏放大到 88px**:朗读讲解的口型动作看得更清楚。
