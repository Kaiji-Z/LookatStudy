...
"settings.multimodal.test_override": "测试模型",
    ...
    "chat.speech.asr_model_missing": "语音输入模型还没下载。到 设置 → 语音能力 下载后即可说话。",
    "chat.speech.asr_start_fail": "麦克风启动失败，请检查系统权限。",
    "settings.speech.title": "语音能力",
    "settings.speech.desc": "本地语音朗读与语音输入。模型下载后离线可用，不联网不上传。",
...
"settings.multimodal.test_override": "Test model",
    ...
    "chat.speech.asr_model_missing": "Voice input model not downloaded yet. Get it in Settings → Speech.",
    "chat.speech.asr_start_fail": "Microphone failed to start. Check system permissions.",
    "settings.speech.title": "Speech",
    "settings.speech.desc": "Local text-to-speech and voice input. Models run offline once downloaded.",
