...
const translations: Record<Lang, Record<string, string>> = {
  "zh-CN": {
    ...
    "import.url.desc": "粘贴任意链接自动识别:GitHub 仓库 / arXiv 论文 / 网页文章 / B站·YouTube 视频(转写成课;更多站点需自装 yt-dlp)。",
    "import.btn.url": "导入",
...
"notebook.board.empty": "对话里产生概念图、流程图、对比表、代码讲解时,这里会实时展示最新的一幅大图,方便边看边问。",
    ...
    "settings.multimodal.mode_reuse": "复用主模型",
        "settings.multimodal.mode_custom": "自定义",
...
"quiz.hook.lineWrong": "❌ 第{{n}}题「{{prompt}}」:我选了「{{chosen}}」,正确答案是「{{answer}}」",
  ...
  en: {
    ...
    "import.url.desc": "Paste any link — GitHub repo / arXiv paper / web article / Bilibili·YouTube video (transcribed into a course; more sites need yt-dlp installed).",
...
"notebook.board.empty": "When the tutor produces a concept map, diagram, comparison table, or code walkthrough in chat, the latest one is rendered here in full size.",
    ...
    "settings.multimodal.mode_reuse": "Reuse main model",
    "settings.multimodal.mode_custom": "Custom",
