...
"notebook.board.empty": "对话里产生概念图、流程图、对比表、代码讲解时,这里会实时展示最新的一幅大图,方便边看边问。",
    ...
    "settings.companion.toggle.desc": "小焰常驻课程地图与笔记本:高光时刻一起庆祝,朗读课文时对口型,答错时给你打气,空闲时打盹。只在本地运行,随时可关。",
    "companion.name": "小焰",
...
"notebook.board.empty": "When the tutor produces a concept map, diagram, comparison table, or code walkthrough in chat, the latest one is rendered here in full size.",
    ...
    "settings.companion.toggle.desc": "Ember lives in the course map and notebook: celebrates wins with you, lip-syncs while reading lessons aloud, cheers you on after wrong answers, and dozes off when idle. Fully local, always optional.",
