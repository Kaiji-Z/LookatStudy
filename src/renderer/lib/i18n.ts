...
"settings.multimodal.test_override": "测试模型",
    ...
    "chat.speech.engine_unavailable": "此平台暂不支持本地语音引擎（桌面版可用）。",
...
"settings.multimodal.test_override": "Test model",
    ...
    "chat.speech.engine_unavailable": "Local speech engine is not available on this platform (desktop only for now).",
