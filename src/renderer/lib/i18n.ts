...
"settings.multimodal.test_override": "测试模型",
    ...
    "chat.speech.engine_unavailable": "语音引擎未就位。桌面版开箱可用；Termux 端运行 bash install-termux.sh --voice 安装（约 12MB）。",
    ...
    "chat.speech.azure_stt_key_missing": "Azure 听写缺少密钥。到 设置 → 语音能力 填写。",
    "chat.speech.azure_stt_region_missing": "Azure 听写缺少区域。到 设置 → 语音能力 填写。",
    "chat.speech.asr_model_missing": "听写模型还没下载。到 设置 → 语音能力 下载 Whisper(本地离线),或改用 Groq/Azure 云端。",
    ...
    "settings.speech.title": "语音能力",
    "settings.speech.desc": "朗读默认走 Edge 在线通道（免费、无需密钥）；本地档下载模型后离线可用。",
    ...
    "settings.speech.engine.azure_note": "Azure 官方语音通道，自带密钥，F0 层每月 50 万字符免费。",
    "settings.speech.engine.local_note": "Kokoro 本地模型（约 430MB），完全离线；下载后自动作为在线通道故障的兜底。",
    "settings.speech.voice": "音色",
    "settings.speech.speed": "语速",
    "settings.speech.azure_key": "密钥",
    "settings.speech.azure_region": "区域",
    "settings.speech.asr_engine": "听写引擎",
    "settings.speech.asr_engine.local": "本地离线",
    "settings.speech.asr_engine.groq": "Groq",
    "settings.speech.asr_engine.azure": "Azure",
    "settings.speech.asr_engine.local_note": "Whisper 离线转写(自带标点,中文质量好);下载模型后完全离线,Turbo 约 1GB / Small 约 360MB。",
    "settings.speech.asr_engine.groq_note": "whisper-large-v3-turbo 云端转写(最快最准);复用模型服务里的 Groq 密钥,还没配。",
    "settings.speech.asr_engine.groq_ready": "whisper-large-v3-turbo 云端转写(最快最准);已复用模型服务的 Groq 密钥,零额外配置。",
    "settings.speech.asr_engine.azure_note": "Azure 听写,自带密钥,F0 层每月 5 小时免费。",
    ...
    "settings.speech.model.asr": "语音输入引擎（Zipformer，约 200MB）",
...
"settings.multimodal.test_override": "Test model",
    ...
    "chat.speech.engine_unavailable": "Speech engine not installed. Desktop has it built in; on Termux run: bash install-termux.sh --voice (~12MB).",
    ...
    "chat.speech.azure_stt_key_missing": "Azure dictation key missing. Fill it in Settings → Speech.",
    "chat.speech.azure_stt_region_missing": "Azure dictation region missing. Fill it in Settings → Speech.",
    "chat.speech.asr_model_missing": "Dictation model not downloaded. Get Whisper in Settings → Speech (local offline), or use Groq/Azure cloud.",
    ...
    "settings.speech.desc": "Read-aloud defaults to the free Edge online channel (no key needed); the local tier runs offline once its model is downloaded.",
    ...
    "settings.speech.engine.azure_note": "Official Azure Speech channel, bring your own key; the F0 tier includes 0.5M characters per month.",
    "settings.speech.engine.local_note": "Kokoro local model (~430MB), fully offline; also acts as automatic fallback when online channels fail.",
    "settings.speech.voice": "Voice",
    "settings.speech.speed": "Speed",
    "settings.speech.azure_key": "Key",
    "settings.speech.azure_region": "Region",
    ...
    "settings.speech.asr_engine.groq_note": "whisper-large-v3-turbo cloud transcription (fastest, most accurate); reuses the Groq key from model providers — not configured yet.",
    "settings.speech.asr_engine.groq_ready": "whisper-large-v3-turbo cloud transcription (fastest, most accurate); reuses your configured Groq key, zero extra setup.",
    "settings.speech.asr_engine.azure_note": "Azure dictation, bring your own key; the F0 tier includes 5 hours per month.",
    ...
    "settings.speech.model.asr": "Voice input engine (Zipformer, ~200MB)",
