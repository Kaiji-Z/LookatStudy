...
"settings.multimodal.test_override": "测试模型",
    ...
    "chat.speech.dictation_stop": "结束听写",
    "chat.speech.dictation_ptt": "语音输入(点击或按住说话)",
    ...
    "settings.speech.asr_auto_send": "静音后自动发送",
    "settings.speech.asr_ux_note": "按住麦克风按钮可直接说话(松开结束);快点击仍是开关模式。",
...
"settings.multimodal.test_override": "Test model",
    ...
    "chat.speech.dictation_stop": "Stop dictation",
    "chat.speech.dictation_ptt": "Voice input (click, or hold to talk)",
    ...
    "settings.speech.asr_auto_send": "Auto-send after silence",
    "settings.speech.asr_ux_note": "Hold the mic button to talk (release to finish); a quick click still toggles.",
