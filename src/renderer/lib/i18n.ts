...
const translations: Record<Lang, Record<string, string>> = {
  "zh-CN": {
    ...
    "import.url.desc": "粘贴任意链接自动识别:GitHub 仓库走完整导入,arXiv 论文下载 PDF 提取,其余网页抽取正文成课。",
    "import.btn.url": "导入",
    ...
    "import.tab.audio": "音频",
    "import.audio.desc": "播客/讲座音频本地转写成课(wav/mp3/m4a/flac,可多选=多集)。首次使用自动下载 Whisper 模型(约 1GB)。",
...
"quiz.hook.lineWrong": "❌ 第{{n}}题「{{prompt}}」:我选了「{{chosen}}」,正确答案是「{{answer}}」",
  ...
  en: {
    ...
    "import.url.desc": "Paste any link — GitHub repos get the full import, arXiv papers are downloaded and extracted, other pages get their article text extracted into a course.",
    ...
    "import.audio.desc": "Podcasts and lecture recordings transcribed locally into a course (wav/mp3/m4a/flac, multi-select = multiple episodes). Whisper model (~1 GB) downloads automatically on first use.",
